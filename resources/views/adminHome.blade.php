                ...
                <div class="col-md-4 mb-4" style="height: 200px">
                        ...
                        <div class="card text-light bg-primary add-card">
                            <label for="file-input" class="d-flex align-items-center justify-content-center w-100 h-100">
                                ...
                                <button type="button" class="btn  w-100 mt-2" id="file-input" data-toggle="modal" data-target="#exampleModal">                                    
                                </button>                            
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Tambahkan Gambar Halaman Depan</h5>
                                ...
                                <div class="modal-body">
                                    <div class="modal-body">
                                        <img src="https://via.placeholder.com/1000x500" height="200px" width="100%" alt="">
                                      
                                      <div class="form-group">
                                        <label for="helpInputTop">Gambar</label>
                                        <small class="text-muted">Maximal 2mb, Ukuran 1000x2000px</small>
