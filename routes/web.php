...
Route::get('/signin', [AuthController::class,'formLogin'])->name('login');

Route::get('/login', [AuthController::class,'formLogin2'])->name('authForm');
...
Route::get('pelatihan/{pelatihanId}/export-participants', [PelatihanController::class, 'exportParticipants'])->name('pelatihan.exportParticipants');
